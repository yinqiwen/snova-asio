...
cppcoro::async_mutex::async_mutex() noexcept : m_state(not_locked), m_waiters(nullptr) {}
...
bool cppcoro::async_mutex::try_lock() noexcept {
  ...
  return m_state.compare_exchange_strong(oldState, locked_no_waiters, std::memory_order_acquire,
