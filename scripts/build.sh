...
if [ "$machine" = "Linux" ]; then
    bazel build --define local_musl=true --features=fully_static_link --copt=-flto --cxxopt=-std=c++20 --incompatible_enable_cc_toolchain_resolution --platforms=//toolchains:"${platform}" //...
else
